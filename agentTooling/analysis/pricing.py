...
# default — Fable 5.1 and Mythos 5.1 read cache at 0.025x, and Opus 5.5 at 0.05x,
...
RATES: dict[str, dict] = {
    ...
    "claude-sonnet-5": {
        ...
        # (platform.claude.com/docs/en/about-claude/pricing, read 2026-09-04 and
        # again 2026-09-22): the
